...
[![GitHub license](https://img.shields.io/npm/l/parsel-ts.svg)](https://github.com/david-luna/parsel-ts/blob/master/README.md)
...
Reason to do it is to learn more about CSS and its grammar but also to provide typings to another project I'm woring on and add some tweaks.
